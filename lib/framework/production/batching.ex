defmodule Framework.Production.Batching do
  @moduledoc """
  ...
  alias Ash.Changeset
  alias Framework.Catalog
  alias Framework.Catalog.Services.BatchCostCalculator
  alias Framework.Inventory
  alias Framework.Inventory.Lot
  alias Framework.Orders
  alias Framework.Orders.OrderItemBatchAllocation
  alias Framework.Orders.OrderItemLot
  alias Framework.Orders.ProductionBatch
  alias Framework.Orders.ProductionBatchLot
  alias Decimal, as: D
