defmodule Framework.Inventory do
  @moduledoc false
  use Ash.Domain,
  ...
  resources do
    resource Framework.Inventory.Lot do
    ...
    resource Framework.Inventory.Material do
    ...
    resource Framework.Inventory.Movement do
      define :adjust_stock, action: :adjust_stock
      define :list_movements, action: :read
    end

    resource Framework.Inventory.Supplier do
    ...
    resource Framework.Inventory.PurchaseOrder do
    ...
    resource Framework.Inventory.PurchaseOrderItem do
    ...
    resource Framework.Inventory.Allergen do
    ...
    resource Framework.Inventory.MaterialAllergen

    resource Framework.Inventory.NutritionalFact do
    ...
    resource Framework.Inventory.MaterialNutritionalFact
  end
end
