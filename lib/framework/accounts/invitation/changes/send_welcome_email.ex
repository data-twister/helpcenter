# lib/framework/accounts/invitation/changes/send_welcome_email.ex
defmodule Framework.Accounts.Invitation.Changes.SendWelcomeEmail do
  @moduledoc """
  ...
  ## Parameters
    ...
    - invitation: The invitation struct containing email, token, and tenant
  ...
  defp build_email_body(email, token, tenant) do
    ...
    """
    <p>Hello, #{email}!</p>
    <p>Welcome to the <strong>#{tenant}</strong> tenant!</p>
    <p>Please click the link below to sign in and get started:</p>
    <p><a href="#{sign_in_url}">Sign In</a></p>
    <p>If you have any issues, please contact the tenant administrator.</p>
    """
  end
