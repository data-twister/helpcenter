# lib/framework/accounts/invitation/changes/set_invitation_attributes.ex
defmodule Framework.Accounts.Invitation.Changes.SetInvitationAttributes do
  ...
  defp set_attributes(changeset, context) do
    ...
    |> Ash.Changeset.force_change_attribute(:tenant, changeset.tenant)
    |> Ash.Changeset.force_change_attribute(:token, Ash.UUIDv7.generate())
    |> Ash.Changeset.force_change_attribute(:tenant, context.actor.current_tenant)
