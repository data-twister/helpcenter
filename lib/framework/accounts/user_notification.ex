# lib/framework/accounts/user_notification.ex
defmodule Framework.Accounts.UserNotification do
  use Ash.Resource,
  ...
  oban do
    triggers do
      ...
      list_tenants fn -> Framework.Repo.all_tenants() end
      ...
      trigger :send do
        ...
        worker_module_name Framework.Accounts.UserNotification.AshOban.Worker.Send
        scheduler_module_name Framework.Accounts.UserNotification.AshOban.Scheduler.Send
      end
    end
  end
  ...
  actions do
    ...
    update :send do
      ...
      change Framework.Accounts.UserNotification.Changes.DeliverEmail
    end
  ...
  relationships do
    belongs_to :sender, Framework.Accounts.User do
      description "The user who sent the notification"
      source_attribute :recipient_user_id
    end

    belongs_to :recipient, Framework.Accounts.User do
      description "The user who received the notification"
      source_attribute :recipient_user_id
    end
  end
