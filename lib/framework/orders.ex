defmodule Framework.Orders do
  @moduledoc false
  use Ash.Domain,
    extensions: [AshJsonApi.Domain, AshGraphql.Domain]

  alias Framework.Orders.Order
  ...
  resources do
    ...
    resource Framework.Orders.OrderItem do
    ...
    resource Framework.Orders.ProductionBatch do
      ...
      define :list_open_batches_for_product, action: :open_for_item
    end

    resource Framework.Orders.OrderItemLot do
      define :list_order_item_lots, action: :read
    end

    resource Framework.Orders.OrderItemBatchAllocation do
    ...
    resource Framework.Orders.ProductionBatchLot do
