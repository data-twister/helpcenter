defmodule Production.InventoryForecasting do
  @moduledoc """
  ...
  alias Ash.NotLoaded
  alias Production.Inventory.ForecastRow
  alias Production.Inventory.Material
  alias Production.Inventory.PurchaseOrderItem
  alias Production.Orders
  alias Production.Settings
  alias Decimal, as: D
  ...
  defp latest_bom(product_id, actor) do
    ...
    |> Production.Catalog.list_boms_for_product!(actor: actor)
    |> List.first()
  end
