defmodule Framework.Changes.SetTenant do
  @moduledoc """
  Sets user current_tenant on the changeset as the tenant for change query
  ...
  def change(changeset, _opts, %{tenant: nil, actor: actor} = _context) do
    Ash.Changeset.set_tenant(changeset, actor.current_tenant)
  end
