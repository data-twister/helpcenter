defmodule Framework.Orders.OrderItemBatchAllocation do
  @moduledoc false
  use Ash.Resource,
    otp_app: :framework,
  ...
  actions do
    ...
    read :for_batch do
      ...
      prepare build(load: [order_item: [order: [:reference], item: [:name]]])
    end
  ...
  validations do
    validate {Framework.Orders.Validations.AllocationItemMatch, []}
    ...
    validate {Framework.Orders.Validations.AllocationWithinItemQuantity, []}
  end
