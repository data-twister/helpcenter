# lib/framework/extensions/ash_parental/transformers/add_has_many_children_relationship.ex
defmodule Framework.Extensions.AshParental.Transformers.AddHasManyChildrenRelationship do
  use Spark.Dsl.Transformer

  def after?(Framework.Extensions.AshParental.Transformers.AddParentIdAttribute), do: true
