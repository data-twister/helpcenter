...
defmodule Framework.Extensions.AshParental do
  @moduledoc """
  ...
  @transformers [
    Framework.Extensions.AshParental.Transformers.AddParentIdAttribute,

    # Add relationships after the attribute and aggregate have been added
    Framework.Extensions.AshParental.Transformers.AddBelongsToParentRelationship,
    Framework.Extensions.AshParental.Transformers.AddHasManyChildrenRelationship,

    # Aggregates
    Framework.Extensions.AshParental.Transformers.AddChildrenCountAggregate,

    # Add the destroy children change last
    Framework.Extensions.AshParental.Transformers.AddDestroyWithChildrenChange
  ]
