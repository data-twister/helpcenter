# lib/framework/extensions/ash_parental/ash_parental_test.exs
defmodule Framework.Extensions.AshParentalTest do
  use ExUnit.Case

  # Define a simple Ash resource for testing purposes
  defmodule Comment do
    use Ash.Resource,
      domain: Framework.Extensions.AshParentalTest.Domain,
  ...
  defmodule Domain do
    ...
    resources do
      resource Framework.Extensions.AshParentalTest.Comment
      resource Framework.Extensions.AshParentalTest.Category
    end
  end
  ...
  alias Framework.Extensions.AshParentalTest.Comment
