defmodule Framework.Inventory.PurchaseOrder do
  @moduledoc false
  use Ash.Resource,
    otp_app: :framework,
    ...
    update :receive do
      ...
      change after_action(fn changeset, po, _ctx ->
               ...
               Enum.each(receipts, fn r ->
                 ...
                 # Create/find lot
                 lot =
                   Ash.Seed.seed!(Framework.Inventory.Lot, %{
                     lot_code: lot_code,
                 ...
                 Framework.Inventory.adjust_stock(
                   %{
                     material_id: material_id,
                     lot_id: lot.id,
                     quantity: qty,
  ...
  relationships do
    ...
    has_many :items, Framework.Inventory.PurchaseOrderItem
  end
