# lib/framework_web/controllers/tenant_invitation_acceptance_controller.ex
defmodule FrameworkWeb.TenantInvitationAcceptanceController do
  use FrameworkWeb, :controller

  @doc """
  Accepts a tenant invitation using a tenant and token, updating the invitation status.
