# lib/framework_web/live/categories/category_form.ex
defmodule FrameworkWeb.Categories.CategoryForm do
  ...
  ### Example:
      - <FrameworkWeb.Categories.CategoryForm.form /> for creating a new category
      - <FrameworkWeb.Categories.CategoryForm.form category_id={...}/> for editing an existing category
  ...
  # <-- Pass actor so we know what tenant to store data in
