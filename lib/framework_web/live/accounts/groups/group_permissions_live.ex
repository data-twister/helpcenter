# lib/framework_web/live/accounts/groups/edit_group_live.ex
defmodule FrameworkWeb.Accounts.Groups.GroupPermissionsLive do
  ...
  def render(assigns) do
    ...
    <%!-- Group permissions --%>
    <div class="mt-4">
      <FrameworkWeb.Accounts.Groups.GroupPermissionForm.form
        group_id={@group_id}
        actor={@current_user}
      />
    </div>
  ...
  defp get_group(actor, group_id) do
    Ash.get!(Framework.Accounts.Group, group_id, actor: actor)
  end
end
