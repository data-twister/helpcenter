defmodule FrameworkWeb.Accounts.Users.UserInvitationsLive.InviteNewUserFormTest do
  use FrameworkWeb.ConnCase
  alias FrameworkWeb.Accounts.Users.UserInvitationsLive.InviteNewUserForm
  ...
  describe "Invite New User Form" do
    test "Invite user form renders successfully" do
      ...
      assert html =~ "Invite a new member to your tenant"
    end
