defmodule FrameworkWeb.SettingsLive.ApiKeysComponent do
  @moduledoc false
  use FrameworkWeb, :live_component

  alias Framework.Accounts
  alias Framework.Accounts.ApiKey
  ...
  def render(assigns) do
    ...
    <div class="space-y-6">
      <.header>
        <:subtitle>
          Manage API keys for programmatic access to Framework. Keys use scoped permissions per resource.
        </:subtitle>
        API Keys
        <:actions>
