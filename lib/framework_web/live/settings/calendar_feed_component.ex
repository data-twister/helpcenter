defmodule FrameworkWeb.SettingsLive.CalendarFeedComponent do
  @moduledoc false
  ...
  def render(assigns) do
    ...
    <div class="space-y-6">
      <.header>
        Calendar Feed
        <:subtitle>
          Subscribe to your Framework orders and production batches in Google Calendar, Apple Calendar, or any app that supports iCal feeds.
        </:subtitle>
      </.header>
  ...
  defp build_feed_url(raw_key) do
    base = FrameworkWeb.Endpoint.url()
