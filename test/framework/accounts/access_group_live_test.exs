# test/framework/accounts/access_group_live_test.exs
defmodule Framework.Accounts.AccessGroupLiveTest do
  use FrameworkWeb.ConnCase, async: false
  import AuthCase

  describe "User Access Group Test:" do
    test "All actions can be listed for permissions" do
      assert Framework.permissions()
             |> is_list()
    end
    ...
    test "Group form renders successfully" do
      ...
      html = render_component(FrameworkWeb.Accounts.Groups.GroupForm, assigns)
    ...
    test "Access group can be edited", %{conn: conn} do
      ...
      for perm <- Framework.permissions() do
