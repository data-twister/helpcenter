# test/framework/accounts/user_group_test.exs
defmodule Framework.Accounts.UserGroupTest do
  ...
  describe "User Access Group Tests" do
    test "Group can be added to a user" do
      ...
      assert user.current_tenant == Ash.Resource.get_metadata(user_group, :tenant)
