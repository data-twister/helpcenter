defmodule Framework.KnowledgeBase.ArticleTest do
  alias Framework.KnowledgeBase.ArticleFeedback
  use FrameworkWeb.ConnCase, async: false
  alias Framework.KnowledgeBase.ArticleTag
  ...
  describe "Article Tests" do
    ...
    test "Article and Category can be created at the same time" do
      ...
      Framework.KnowledgeBase.Article
    ...
    test "Articles can be filtered by their tags" do
      user = create_user()
      create_articles(user.current_tenant)
      category = get_category(user.current_tenant)
